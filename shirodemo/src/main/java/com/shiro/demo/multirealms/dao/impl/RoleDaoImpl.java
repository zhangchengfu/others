...
public class RoleDaoImpl implements RoleDao {
	...
	private boolean exsits(Long roleId, Long permissionId) {
		String sql = "select count(1) from sys_roles_permissions where role_id=? and permission_id=?";
		return this.jdbcTemplate.queryForObject(sql, Integer.class,roleId,permissionId) != 0;
	}
